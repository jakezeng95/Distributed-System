...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            /*
            * while true makes it capable of receiving multiple messages*/
            while(true){
                try {
                    Socket socket = serverSocket.accept();
                    //wrap into BufferedInputStream reads more faster
                    //https://stackoverflow.com/questions/18600331/why-is-using-bufferedinputstream-to-read-a-file-byte-by-byte-faster-than-using-f
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /*.getOutputStream() returns output stream of the sockets
                https://developer.android.com/reference/java/net/Socket.html#getOutputStream()*/
